 ...
 * Description:
 *
 *     Copy all of the code in GR32_Polygons.pas shipped with
 *   Graphics32 1.9.1 Fixed which was at the Branch directory of Graphics32
 *   repository on SourceForge.net to this unit, and renamed the unit to
 *   "GR32_PolygonsOld" for providing backward-capatiblity to old Graphics32.
 *
 * *****************)
